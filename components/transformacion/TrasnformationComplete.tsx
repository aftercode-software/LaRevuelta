                ...
                <aside className={ASIDELEFT}>
                  <ul className={LIST}>
                    ...
                    <li>
                      ...
                      , para determinar eficiencia de cada canal y aporte real
                      al negocio.
                    </li>
                    <li>
                      <b className="font-bold">Análisis de procesos actuales</b>
                      , funcionamiento de tareas, intervención de diferentes
                      áreas.
                    </li>
                    <li>
                      <b className="font-bold">
                        Análisis de la utilización y maximización de valor de
                        cada canal
                      </b>
              ...
              <div className="flex flex-col  lg:flex-row">
                <aside className="xl:w-[55%] xl:mr-10">
                  <ul className={LIST}>
                    ...
                    <li>
                      <b className="font-bold">Análisis de mercado</b>:
                      percepción de la marca, productos, competencia y cuota de
                      mercado.
                    </li>
                    <li>
                ...
                <aside className="mt-10 xl:mt-0 xl:w-[45%]">
                  ...
                  <ul className={LIST}>
                    ...
                    <li>
                      ...
                      , facilitando la comprensión de los resultados y apoyando
          ...
          <section className="flex flex-col   w-full">
            ...
            <section>
                ...
                <aside className={ASIDELEFT}>
                  <ul className={LIST}>
                    <p>
                      ...
                      para potenciar tus resultados hoy con tu estructura
                      actual.
                    </p>
                    <p>
                    ...
                    <li>
                      ...
                      para medir el impacto de cada acción y ajustar el plan
              ...
              <p className={ULTIMOTEXTO}>
                ...
                potenciar y{" "}
                <b className="font-bold">
                  generar un shock de crecimiento inmediato en la estructura de
                  la empresa
                </b>
              ...
              <p className={ULTIMOTEXTO}>
                ...
                tienen como propósito explotar eso que hace distinta a tu
                empresa acercándola a su público ideal.
              </p>
            </section>
          </section>
        </div>
        ...
        <div className={BOX}>
          <section className="flex flex-col   w-full">
            ...
            <section>
              <p className={SUBTITULO}>
                <b className={SUBTITULO1}>
                  Redefine tus necesidades estratégicas y enfrenta nuevos
              ...
              <div className="flex flex-col lg:flex-row">
                <aside className={ASIDELEFT}>
                  <ul className={LIST}>
                    ...
                    <li>
                      <b className="font-bold">
                        Definición de lanzamiento de nuevos productos y
                        servicios
                      </b>{" "}
                    ...
                    <li>
                      ...
                      específica para descubrir y aprovechar nuevas
                      oportunidades
                    </li>
                    <li>
                      <b className="font-bold">
                ...
                <aside className={ASIDERIGHT}>
                  ...
                  <ul className={LIST}>
                    <li>
                      ...
                      , orientados a afrontar nuevos desafíos y alcanzar
              ...
              <p className={ULTIMOTEXTO}>
                Esta etapa{" "}
                <span className="text-secundario-500"> nos apasiona</span> por
                el alto grado de diversión que tiene y por la
                <b className="font-bold"> continua experimentación</b> que se
                vive en búsqueda de ir consolidando{" "}
                <b className="font-bold">
              ...
              <p className={ULTIMOTEXTO}>
                ...
                por hacer de los{" "}
                <b className="font-bold">usuarios y del mundo</b>, a través de
